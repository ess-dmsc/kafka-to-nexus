...
public:
  ...
  virtual void addPartitionAtOffset(std::string const &Topic, int PartitionId, int64_t Offset) = 0;
...
public:
  ...
  ///
  /// Replaces any exisiting topics + partitions that are currently being consumed.
  /// \note This is a non blocking call.
  ///
  /// \param Topic The name of the topic to add.
  /// \param Partition The partition id.
  /// \param Offset Start offset to consume from.
  void addPartitionAtOffset(std::string const &Topic, int PartitionId, int64_t Offset) override;
