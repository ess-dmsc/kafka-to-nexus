...
public:
  ...
  std::filesystem::path construct_filepath(std::filesystem::path const &prefix, std::string const &filename);
    std::filesystem::path construct_template_path(std::filesystem::path const &prefix, std::string const &instrument_name);
