...
static FileWriter::FlatbufferReaderRegistry::Registrar<NDAr>
    RegisterNDArGuard("NDAr");

bool NDAr::verify(FlatbufferMessage const &Message) const {
...
uint64_t
NDAr::timestamp(FlatbufferMessage const &Message) const {
