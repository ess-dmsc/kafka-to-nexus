...
//  "some_topic", 4, std::chrono::system_clock::now(), 10ms),
//  RETURN_TIME_OFFSET);
//}
//
...
//  EXPECT_EQ(KafkaW::getPartitionsForTopicImpl<UsedProducerMockAlt>("Some_broker",
//  "some_topic", 10ms), ExpectedPartitions);
//}