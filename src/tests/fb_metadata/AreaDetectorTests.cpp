...
class ADWriterStandIn : public NDAr::NDAr {
public:
  using NDAr::NDAr::ChunkSize;
  using NDAr::NDAr::ArrayShape;
  using NDAr::NDAr::Type;
  using NDAr::NDAr::ElementType;
  using NDAr::NDAr::Values;
  using NDAr::NDAr::Timestamp;
  using NDAr::NDAr::CueInterval;
  using NDAr::NDAr::CueTimestamp;
  using NDAr::NDAr::CueTimestampIndex;
};
