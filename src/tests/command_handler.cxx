...
TEST_F(CommandHandler_Test, start_stop) {
  ASSERT_EQ(FileWriter::find_time(new_00,"start_time"),FileWriter::ESSTimeStamp{123456789});
  ASSERT_EQ(FileWriter::find_time(new_00,"stop_time"),FileWriter::ESSTimeStamp{123456790});
  ASSERT_EQ(FileWriter::find_time(new_01,"start_time"),FileWriter::ESSTimeStamp{123456789});
  ASSERT_EQ(FileWriter::find_time(new_01,"stop_time"),FileWriter::ESSTimeStamp{0});
  ASSERT_EQ(FileWriter::find_time(new_03,"start_time"),FileWriter::ESSTimeStamp{0});
  ASSERT_EQ(FileWriter::find_time(new_03,"stop_time"),FileWriter::ESSTimeStamp{0});
}
