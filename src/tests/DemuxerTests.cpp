...
TEST_F(MessageTimeExtractionTest, Success) {
  ...
  TEST_F(DemuxerTest, Success) {
    ...
    EXPECT_EQ(TestDemuxer.error_message_too_small, size_t(0));
    EXPECT_EQ(TestDemuxer.error_no_flatbuffer_reader, size_t(0));
    EXPECT_EQ(TestDemuxer.error_no_source_instance, size_t(0));
  }
  ...
  TEST_F(DemuxerTest, WrongSourceName) {
    ...
    EXPECT_EQ(TestDemuxer.messages_processed, size_t(0));
    EXPECT_EQ(TestDemuxer.error_message_too_small, size_t(0));
    EXPECT_EQ(TestDemuxer.error_no_flatbuffer_reader, size_t(0));
    EXPECT_EQ(TestDemuxer.error_no_source_instance, size_t(1));
  }
  ...
  TEST_F(DemuxerTest, WrongKey) {
    ...
    EXPECT_EQ(TestDemuxer.messages_processed, size_t(0));
    EXPECT_EQ(TestDemuxer.error_message_too_small, size_t(0));
    EXPECT_EQ(TestDemuxer.error_no_flatbuffer_reader, size_t(1));
    EXPECT_EQ(TestDemuxer.error_no_source_instance, size_t(0));
  }
  ...
  TEST_F(DemuxerTest, MessageTooSmall) {
    ...
    EXPECT_EQ(Result, ProcessMessageResult::ERR);
    EXPECT_EQ(TestDemuxer.messages_processed, size_t(0));
    EXPECT_EQ(TestDemuxer.error_message_too_small, size_t(1));
    EXPECT_EQ(TestDemuxer.error_no_flatbuffer_reader, size_t(0));
    EXPECT_EQ(TestDemuxer.error_no_source_instance, size_t(0));
  }
