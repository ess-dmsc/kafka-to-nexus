...
TEST(HDFFileAttributesTest,
  ...
  auto StringAttr = hdf5::node::get_group(TestFile.getRootGroup(),
...
TEST(HDFFileAttributesTest,
  ...
  auto IntAttr =
      node::get_group(TestFile.getRootGroup(), "group_with_typed_attrs")
...
TEST(HDFFileAttributesTest, whenCommandContainsArrayAttrItIsWrittenToFile) {
  ...
  auto ArrayAttr =
      node::get_group(TestFile.getRootGroup(), "group_with_array_attrs")
...
TEST(HDFFileAttributesTest,
  ...
  {
    auto StringAttr =
        node::get_group(TestFile.getRootGroup(), "group_with_attributes")
...
TEST(HDFFileAttributesTest, ObjectOfAttributesOfTypeString) {
  ...
  {
    auto StringAttr = node::get_group(TestFile.getRootGroup(),
