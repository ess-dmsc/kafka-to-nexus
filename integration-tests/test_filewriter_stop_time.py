...
def test_start_and_stop_time_are_in_the_past(
    ...
    with OpenNexusFile(file_path) as file:
        ...
        assert file["entry/start_time"][0] == datetime.utcfromtimestamp(file_start_time).isoformat() + 'Z'
        assert file["entry/end_time"][0] == datetime.utcfromtimestamp(file_stop_time).isoformat() + 'Z'
