...
container_build_nodes = [
  'centos7': new ContainerBuildNode('essdmscdm/centos7-build-node:4.0.0', '/bin/bash -e'),
  'centos7-release': new ContainerBuildNode('essdmscdm/centos7-build-node:4.0.0', '/bin/bash -e'),
