...
container_build_nodes = [
  'centos7': new ContainerBuildNode('essdmscdm/centos7-build-node:3.6.0', '/usr/bin/scl enable rh-python35 devtoolset-6 -- /bin/bash -e'),
  'centos7-release': new ContainerBuildNode('essdmscdm/centos7-build-node:3.6.0', '/usr/bin/scl enable rh-python35 devtoolset-6 -- /bin/bash -e'),
